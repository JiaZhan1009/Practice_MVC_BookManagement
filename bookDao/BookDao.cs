...
namespace bookDao
{
    ...
    {
        private readonly CodeDao codeDao;

        private SqlConnection _conn;

        public BookDao(SqlConnection conn)
        {
            _conn = conn;
        }
        public BookDao()
        ...
        public List<Book> GetBooksByConditionOrAll(Book book)
        {
            ...
            if (!String.IsNullOrWhiteSpace(book.BookClassId))
            ...
            List<Book> result = codeDao.MapDataToList<Book>(dt);
        ...
        public Book GetBookById(int bookId)
        {
            ...
            Book book = codeDao.MapDataToObject<Book>(dt);

            return book;
        }

        public bool UpdateBookByEdit(bookModel.Book book)
        {
            var sql = @" 
                BEGIN TRY
	                BEGIN TRANSACTION
        ...
        public List<LendRecord> GetLendRecord(int bookId)
        {
            ...
            List<LendRecord> result = codeDao.MapDataToList<LendRecord>(dt);
